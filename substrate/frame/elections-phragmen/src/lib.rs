    ...
    fn do_phragmen() -> Weight {
        ...
        let _ =
            sp_npos_elections::seq_phragmen(num_to_elect, candidate_ids, voters_and_votes, None)
                .map(
                    |ElectionResult::<T::AccountId, Perbill> {
                         winners,
                         assignments: _,
                     }| {
                        ...
                        Self::deposit_event(Event::NewTerm {
    ...
    fn updating_candidacy_bond_works() {
        ExtBuilder::default().build_and_execute(|| {
            ...
            assert_eq!(
                Elections::candidates(),
                vec![
                    (4, 4, System::block_number()),
                    (5, 3, System::block_number())
                ]
            );
